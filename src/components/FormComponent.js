	...
	return(
		<>
			<div className="mt-[20px] flex flex-col gap-[10px] sm:w-[90%] max-w-[400px]">
				<div className="">
				    <div id="fullName" className="flex border-solid border-[1px] border-[#37405E] rounded-[5px] h-[50px] items-center hover:border-[#37405E]" onClick={() => onInputClicked("fullName")}>
				...
				<div className="">
				    <div id="email" className="flex border-solid border-[1px] border-[#37405E] rounded-[5px] h-[50px] items-center hover:border-[#37405E]" onClick={() => onInputClicked("email")}>
				...
				<div className="">
				    <div id="phoneNumber" className="flex border-solid border-[1px] border-[#37405E] rounded-[5px] h-[50px] items-center hover:border-[#37405E]" onClick={() => onInputClicked("phoneNumber")}>
				...
				<div id="bookVisitNowButton" className="book-visit-button w-full text-center bg-[#F83821] py-[10px] px-[20px] rounded-[5px] cursor-pointer" onClick={() => validateInput()}>
			...
			<div id="modalOverlay" className="w-[100%] bg-[#000000ab] fixed top-[0px] left-[0px] h-[100%] z-[5] hidden">
				<div id="thankYouModal" className="w-[100%] h-[100%] bg-[#7f808080] fixed z-[6] text-center hidden">
				    <div style={{
				        ...
				        className="text-[#37405E] fixed bg-[#c2d9ff] top-[50%] left-[50%] py-[30px] px-[10px] sm:w-[400px] w-[90%] rounded-[10px] z-[5] leading-[35px] border-solid border-[1px] border-[#37405E]">
